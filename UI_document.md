...
property|type|description|option|option_description|example
---|---|---|---|---|---
color|string|テキストの色<br>rgb表記
anchor_from|string|始点
anchor_to|string|始点に合わせる位置 
layer|string|重なった際に大きい数字が上に表示
offset|string|視点からの位置
size|string|大きさ<br>動作確認出来ず|
text|string|表示するテキスト
shadow|bool|影をつける|true<br>false|つける<br>つけない
localize|booL|翻訳する|true<br>false|する<br>しない
font_type|string|使用するfont|default<br>smooth<br>rune<br>MinecraftTen
backup_font_type|string|font_typeで指定したfontが使用できなかった場合のfont|上記と同様
font_scale_factor|string|fontの大きさの倍率
max_size|string
min_size|string
font_size|string|fontの大きさ|normal<br>large|1倍<br>2倍
text_alignment|string|不明|left<br>center
line_padding|string|行間の大きさ|number
visible|bool|透明にする
locked_alpha|string
anims|string
ignored|bool|全プロパティを無効にする
alpha|string|透明度
enable_profanity_filter|bool<br>string
locked_color|string
